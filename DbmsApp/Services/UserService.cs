...
public class UserService: IUserService
{
	...
	public bool Register(User user, PizzaPlaceContext db)
	{
        ...
        db.Database.ExecuteSqlRaw($"EXEC RegisterUser @firstName=N'{user.FirstName}', @lastName=N'{user.LastName}', @pass={user.Password}, @email=N'{user.Email}', @phone='{user.Phone}'");
